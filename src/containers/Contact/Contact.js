    ...
    return (
      <div className="Contact container-fluid">
        ...
        <div className="content row">
          <div className="col-8 offset-2 col-md-4 offset-md-4 mb-3">
            <address>
              <p>
                <u itemProp="brand">NEJD</u>
                <br />
                <a itemProp="address" href="https://goo.gl/maps/e5ftaRt6YDVT5dwK9" className="ninja">
                  Doorgangstraat 54,
                  9050 Gent
                </a>
              </p>
              <p><a itemProp="email"  href="mailto:info@nejd.be">info@nejd.be</a><br />
                <a itemProp="telephone" href="tel:+32495647823" className="ninja">+32 495 647823</a></p>
              <p className="soc">
          ...
          <div className="col-8 offset-2 col-md-4 offset-md-4 mt-3">
            <p>
